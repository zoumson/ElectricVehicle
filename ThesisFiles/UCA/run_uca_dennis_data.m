...
clear
close all
% 200 evs cost =  1.4077e+03 USD, Dennis 290.04 USD
% 400 evs cost = 2.7643e+03 USD, Dennis: 574.24 USD
% 500 evs cost = 3.5454e+03 USD, Dennis: 730.36 USD
...
evNum = ev_fleet(fleet);
tp = cc_fleet(fleet);



dataName = strcat('Data_', num2str(evNum), '.xls');
