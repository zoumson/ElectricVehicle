...
% contractCapacityNumber  = [50, 833, 1677, 2133];
   contractCapacityNumber  = [50, 833, 1677, 1500];
%  contractCapacityNumber  = [50, 833, 1677, 1000];
% contractCapacityNumber  = [50, 833, 1677, 800];
% % Load data
...
% % % Only pattern1 
% pattern = [pattern1(low, high, low_time, high_time, last_time);...
%     pattern1(low, high, low_time, high_time, last_time);...
%     pattern1(low, high, low_time, high_time, last_time)];

% % % Only pattern2 
% pattern = [pattern2(low, high, low_time, high_time, last_time);...
%     pattern2(low, high, low_time, high_time, last_time);...
%     pattern2(low, high, low_time, high_time, last_time)];
% 
% % % Only pattern3 
pattern = [pattern3(low, high, low_time, high_time, last_time);...
    pattern3(low, high, low_time, high_time, last_time);...
    pattern3(low, high, low_time, high_time, last_time)];
...
plot_ev_tou_pattern_impact(total_ev_pow,...
    transformer_power, figDataName,v2g);
